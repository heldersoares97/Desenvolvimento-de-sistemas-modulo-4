            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="promocao.html">Promocao</a>
                        </li>
                        <li class="nav-item">
			...
			<div class="col-md-6">
				...
				<form class="mt-5" action="CreateController" method="post">
					<div class="form-group">
						...
						<label for="nome">Nacionalidade:</label> <input type="text"
							class="form-control" id="nacionalidade" name="nacionalidade" required>
					</div>
					<div class="form-group">
